  ...
  <div class="container">
    <div class="header">
      <div class="topHeader">
        ...
        <span id="btn" class="navToggler">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="11" id="show" class="display">
            <g fill="#2D314D" fill-rule="evenodd">
              <path d="M0 0h24v1H0zM0 5h24v1H0zM0 10h24v1H0z" />
            </g>
          </svg>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" id="hide" class="hide">
            <g fill="#2D314D" fill-rule="evenodd">
    ...
    <nav class="mobileNav">
      <div class="wrapper">
        <ul>
          <li><a class="nlink active" href="#">Home</a></li>
          <li><a class="nlink" href="#about">About</a></li>
          <li><a class="nlink" href="contact.php">Contact Us</a></li>
    ...
    <div class="digitalBanking">
      <div class="dgtBankInfo">
        ...
        <p class="text-muted">Take your financial life online. Your SparksBank account will be a one-stop-shop for keeping a track of your expenditures,
           budgeting, investing, and much more.</p>
        <button id="requestBtn" onclick="window.location.href='Customers.php';">All Customers</button>
        <button id="requestBtn"onclick="window.location.href='transactions.php';">Transactions</button>
      </div>
    ...
    <section id="about">
    <div class="chooseEbank">
      <h1>Why choose Sparks Bank?</h1>
      <p class="text-muted">We leverage Open Banking to turn your bank account into your financial hub. <br>Control
        your
      ...
      <div class="easyBank">
        <div>
          ...
          <p class="text-muted">Our modern web and mobile applications allow you to keep track of your finances
            wherever you are in the world.</p>
        </div>
        <div>
          <img src="./images/icon-budgeting.svg" alt="icon-budgeting">
          <h1>Simple Budgeting</h1>
          <p class="text-muted">See exactly where your money goes each month. Receive notifications when you’re
            close to hitting your limits.</p>
        </div>
        <div>
          <img src="./images/icon-onboarding.svg" alt="icon-onboarding">
          <h1>Fast Onboarding</h1>
          <p class="text-muted">We don’t do branches. Open your account in minutes online and start taking control
            of your finances right away.</p>
        </div>
        <div>
          <img src="./images/icon-api.svg" alt="icon-api">
          <h1>Open API</h1>
          <p class="text-muted">Manage your savings, investments, pension, and much more from one account. Tracking
    ...
    <div class="footer">
      <div class="footerList">
        ...
        <div class="footerDiv">
          ...
          <p>© Sparks Bank. All Rights Reserved</p>
        </div>
      </div>
    </div>
    <div class="attribution">
      
      Coded by <a href="https://github.com/Apu2002">Aparna Panda</a>.
    </div>
